...
; RUN: not amd-llvm-spirv --spirv-max-version=1.0 %t.bc 2>&1 | FileCheck %s
; RUN: not amd-llvm-spirv --spirv-max-version=1.1 %t.bc 2>&1 | FileCheck %s
; RUN: not amd-llvm-spirv --spirv-max-version=1.2 %t.bc 2>&1 | FileCheck %s
