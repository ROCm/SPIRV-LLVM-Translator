...
// RUN: amd-llvm-spirv --spirv-max-version=1.3 %t.rev.bc -o %t.rev.spv
// RUN: spirv-val %t.rev.spv
// RUN: amd-llvm-spirv --spirv-max-version=1.3 %t.rev.spv -to-text -o - | FileCheck %s --check-prefix=CHECK-SPIRV
