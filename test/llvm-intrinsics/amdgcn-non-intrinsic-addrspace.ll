...
; CHECK-DAG: define spir_func ptr addrspace(1) @get_global_ptr(
define ptr addrspace(1) @get_global_ptr(ptr addrspace(1) %p) {
entry:
  ret ptr addrspace(1) %p
}

; CHECK-DAG: define spir_func ptr addrspace(3) @get_local_ptr(
define ptr addrspace(3) @get_local_ptr(ptr addrspace(3) %p) {
entry:
  ret ptr addrspace(3) %p
}

; CHECK-DAG: define spir_func ptr addrspace(4) @get_constant_ptr(
define ptr addrspace(4) @get_constant_ptr(ptr addrspace(4) %p) {
entry:
