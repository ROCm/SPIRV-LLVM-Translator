...
; Command line:
; clang -cc1 -triple spir constant_sampler.cl -cl-std=cl2.0 -emit-llvm -o amd-llvm-spirv/test/DebugInfo/translate_sampler_initializer.ll -finclude-default-header -debug-info-kind=standalone
