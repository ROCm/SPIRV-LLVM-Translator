; RUN: llvm-as < %s | amd-llvm-spirv -spirv-ext=+SPV_INTEL_function_pointers -o %t.spv
; RUN: amd-llvm-spirv %t.spv -spirv-ext=+SPV_INTEL_function_pointers -to-text -o - | FileCheck %s --check-prefix=CHECK-SPIRV
