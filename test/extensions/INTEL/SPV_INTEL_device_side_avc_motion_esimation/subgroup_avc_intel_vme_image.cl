...
// RUN: llvm-dis < %t.rev.bc | FileCheck %s --check-prefixes=CHECK-amd-llvm-spirv
...
// CHECK-amd-llvm-spirv: %[[VmeImg0:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %src, target("spirv.Sampler") %sampler)
// CHECK-amd-llvm-spirv: %[[VmeImg1:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %ref, target("spirv.Sampler") %sampler)
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImeResultINTEL") @_Z54__spirv_SubgroupAvcImeEvaluateWithSingleReferenceINTELPU3AS141__spirv_VmeImageINTEL__void_1_0_0_0_0_0_0S1_P26__spirv_AvcImePayloadINTEL(target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) %TempSampledImage, target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) %[[VmeImg1]], target("spirv.AvcImePayloadINTEL") %[[ImePayload]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg2:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg3:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg4:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg5:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg6:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg7:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg8:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg9:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg10:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg11:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg12:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg13:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg14:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg15:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg16:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg17:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg18:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg19:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg20:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg21:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg22:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg23:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg24:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg25:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg26:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg27:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg28:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg29:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg30:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: %[[VmeImg31:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[RefImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg32:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg33:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
...
// CHECK-amd-llvm-spirv: %[[VmeImg34:.*]] = call spir_func target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) @_Z21__spirv_VmeImageINTELPU3AS133__spirv_Image__void_1_0_0_0_0_0_0PU3AS215__spirv_Sampler(target("spirv.Image", void, 1, 0, 0, 0, 0, 0, 0) %[[SrcImg]], target("spirv.Sampler") %[[Sampler]])
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicResultINTEL") @_Z38__spirv_SubgroupAvcSicEvaluateIpeINTELPU3AS141__spirv_VmeImageINTEL__void_1_0_0_0_0_0_0P26__spirv_AvcSicPayloadINTEL(target("spirv.VmeImageINTEL", void, 1, 0, 0, 0, 0, 0, 0) %[[VmeImg34]], target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
