...
// RUN: amd-llvm-spirv %t.rev.bc --spirv-ext=+SPV_INTEL_device_side_avc_motion_estimation -o %t.spv
// RUN: amd-llvm-spirv %t.spv --to-text -o - | FileCheck %s --check-prefix=CHECK-SPIRV
...
// CHECK-amd-llvm-spirv: call spir_func i8 @_Z67__spirv_SubgroupAvcMceGetDefaultInterBaseMultiReferencePenaltyINTELhh(i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func i64 @_Z54__spirv_SubgroupAvcMceGetDefaultInterShapePenaltyINTELhh(i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func i32 @_Z58__spirv_SubgroupAvcMceGetDefaultIntraLumaShapePenaltyINTELhh(i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func <2 x i32> @_Z63__spirv_SubgroupAvcMceGetDefaultInterMotionVectorCostTableINTELhh(i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func i8 @_Z58__spirv_SubgroupAvcMceGetDefaultInterDirectionPenaltyINTELhh(i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func i8 @_Z57__spirv_SubgroupAvcMceGetDefaultIntraLumaModePenaltyINTELhh(i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImePayloadINTEL") @_Z37__spirv_SubgroupAvcImeInitializeINTELDv2_thh(<2 x i16> zeroinitializer, i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImePayloadINTEL") @_Z45__spirv_SubgroupAvcImeSetSingleReferenceINTELDv2_shP26__spirv_AvcImePayloadINTEL(<2 x i16> zeroinitializer, i8 0, target("spirv.AvcImePayloadINTEL") %[[ImePayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImePayloadINTEL") @_Z43__spirv_SubgroupAvcImeSetDualReferenceINTELDv2_sS_hP26__spirv_AvcImePayloadINTEL(<2 x i16> zeroinitializer, <2 x i16> zeroinitializer, i8 0, target("spirv.AvcImePayloadINTEL") %[[ImePayload]])
...
// CHECK-amd-llvm-spirv: call spir_func <2 x i16> @_Z40__spirv_SubgroupAvcImeRefWindowSizeINTELhc(i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func <2 x i16> @_Z42__spirv_SubgroupAvcImeAdjustRefOffsetINTELDv2_sDv2_tS0_S0_(<2 x i16> zeroinitializer, <2 x i16> zeroinitializer, <2 x i16> zeroinitializer, <2 x i16> zeroinitializer)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImePayloadINTEL") @_Z50__spirv_SubgroupAvcImeSetMaxMotionVectorCountINTELhP26__spirv_AvcImePayloadINTEL(i8 0, target("spirv.AvcImePayloadINTEL") %[[ImePayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImeSingleReferenceStreaminINTEL") @_Z53__spirv_SubgroupAvcImeGetSingleReferenceStreaminINTELP49__spirv_AvcImeResultSingleReferenceStreamoutINTEL(target("spirv.AvcImeResultSingleReferenceStreamoutINTEL") %[[ImeSRefOut]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImeDualReferenceStreaminINTEL") @_Z51__spirv_SubgroupAvcImeGetDualReferenceStreaminINTELP47__spirv_AvcImeResultDualReferenceStreamoutINTEL(target("spirv.AvcImeResultDualReferenceStreamoutINTEL") %[[ImeDRefOut]])
...
// CHECK-amd-llvm-spirv: call spir_func i8 @_Z43__spirv_SubgroupAvcImeGetBorderReachedINTELhP25__spirv_AvcImeResultINTEL(i8 0, target("spirv.AvcImeResultINTEL") %[[ImeResult]])
...
// CHECK-amd-llvm-spirv: call spir_func i16 @_Z75__spirv_SubgroupAvcImeGetStreamoutSingleReferenceMajorShapeDistortionsINTELP49__spirv_AvcImeResultSingleReferenceStreamoutINTELh(target("spirv.AvcImeResultSingleReferenceStreamoutINTEL") %[[ImeSRefOut]], i8 0)
// CHECK-amd-llvm-spirv: call spir_func i16 @_Z73__spirv_SubgroupAvcImeGetStreamoutDualReferenceMajorShapeDistortionsINTELP47__spirv_AvcImeResultDualReferenceStreamoutINTELhh(target("spirv.AvcImeResultDualReferenceStreamoutINTEL") %[[ImeDRefOut]], i8 0, i8 0)
// CHECK-amd-llvm-spirv: call spir_func i32 @_Z77__spirv_SubgroupAvcImeGetStreamoutSingleReferenceMajorShapeMotionVectorsINTELP49__spirv_AvcImeResultSingleReferenceStreamoutINTELh(target("spirv.AvcImeResultSingleReferenceStreamoutINTEL") %[[ImeSRefOut]], i8 0)
// CHECK-amd-llvm-spirv: call spir_func i32 @_Z75__spirv_SubgroupAvcImeGetStreamoutDualReferenceMajorShapeMotionVectorsINTELP47__spirv_AvcImeResultDualReferenceStreamoutINTELhh(target("spirv.AvcImeResultDualReferenceStreamoutINTEL") %[[ImeDRefOut]], i8 0, i8 0)
// CHECK-amd-llvm-spirv: call spir_func i8 @_Z76__spirv_SubgroupAvcImeGetStreamoutSingleReferenceMajorShapeReferenceIdsINTELP49__spirv_AvcImeResultSingleReferenceStreamoutINTELh(target("spirv.AvcImeResultSingleReferenceStreamoutINTEL") %[[ImeSRefOut]], i8 0)
// CHECK-amd-llvm-spirv: call spir_func i8 @_Z74__spirv_SubgroupAvcImeGetStreamoutDualReferenceMajorShapeReferenceIdsINTELP47__spirv_AvcImeResultDualReferenceStreamoutINTELhh(target("spirv.AvcImeResultDualReferenceStreamoutINTEL") %[[ImeDRefOut]], i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImePayloadINTEL") @_Z41__spirv_SubgroupAvcImeSetWeightedSadINTELjP26__spirv_AvcImePayloadINTEL(i32 0, target("spirv.AvcImePayloadINTEL") %[[ImePayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcImePayloadINTEL") @_Z61__spirv_SubgroupAvcImeSetEarlySearchTerminationThresholdINTELhP26__spirv_AvcImePayloadINTEL(i8 0, target("spirv.AvcImePayloadINTEL") %[[ImePayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcRefPayloadINTEL") @_Z37__spirv_SubgroupAvcFmeInitializeINTELDv2_tmhhhhh(<2 x i16> zeroinitializer, i64 0, i8 0, i8 0, i8 0, i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcRefPayloadINTEL") @_Z37__spirv_SubgroupAvcBmeInitializeINTELDv2_tmhhhhhh(<2 x i16> zeroinitializer, i64 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcRefPayloadINTEL") @_Z53__spirv_SubgroupAvcRefSetBidirectionalMixDisableINTELP26__spirv_AvcRefPayloadINTEL(target("spirv.AvcRefPayloadINTEL") %[[RefPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z37__spirv_SubgroupAvcSicInitializeINTELDv2_t(<2 x i16> zeroinitializer)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z43__spirv_SubgroupAvcSicConfigureIpeLumaINTELhhhhhhhP26__spirv_AvcSicPayloadINTEL(i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z49__spirv_SubgroupAvcSicConfigureIpeLumaChromaINTELhhhhhhttthP26__spirv_AvcSicPayloadINTEL(i8 0, i8 0, i8 0, i8 0, i8 0, i8 0, i16 0, i16 0, i16 0, i8 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z39__spirv_SubgroupAvcSicConfigureSkcINTELjjmhhP26__spirv_AvcSicPayloadINTEL(i32 0, i32 0, i64 0, i8 0, i8 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z55__spirv_SubgroupAvcSicSetSkcForwardTransformEnableINTELmP26__spirv_AvcSicPayloadINTEL(i64 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z50__spirv_SubgroupAvcSicSetBlockBasedRawSkipSadINTELhP26__spirv_AvcSicPayloadINTEL(i8 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z51__spirv_SubgroupAvcSicSetIntraLumaShapePenaltyINTELjP26__spirv_AvcSicPayloadINTEL(i32 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z55__spirv_SubgroupAvcSicSetIntraLumaModeCostFunctionINTELhjjP26__spirv_AvcSicPayloadINTEL(i8 0, i32 0, i32 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcSicPayloadINTEL") @_Z57__spirv_SubgroupAvcSicSetIntraChromaModeCostFunctionINTELhP26__spirv_AvcSicPayloadINTEL(i8 0, target("spirv.AvcSicPayloadINTEL") %[[SicPayload]])
...
// CHECK-amd-llvm-spirv: call spir_func i16 @_Z51__spirv_SubgroupAvcSicGetBestIpeLumaDistortionINTELP25__spirv_AvcSicResultINTEL(target("spirv.AvcSicResultINTEL") %[[SicResult]])
...
// CHECK-amd-llvm-spirv: call spir_func i32 @_Z46__spirv_SubgroupAvcSicGetMotionVectorMaskINTELjh(i32 0, i8 0)
...
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcMcePayloadINTEL") @_Z59__spirv_SubgroupAvcMceSetSourceInterlacedFieldPolarityINTELhP26__spirv_AvcMcePayloadINTEL(i8 0, target("spirv.AvcMcePayloadINTEL") %[[McePayload]])
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcMcePayloadINTEL") @_Z68__spirv_SubgroupAvcMceSetSingleReferenceInterlacedFieldPolarityINTELhP26__spirv_AvcMcePayloadINTEL(i8 0, target("spirv.AvcMcePayloadINTEL") %[[McePayload]])
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcMcePayloadINTEL") @_Z68__spirv_SubgroupAvcMceSetDualReferenceInterlacedFieldPolaritiesINTELhhP26__spirv_AvcMcePayloadINTEL(i8 0, i8 0, target("spirv.AvcMcePayloadINTEL") %[[McePayload]])
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcMcePayloadINTEL") @_Z60__spirv_SubgroupAvcMceSetInterBaseMultiReferencePenaltyINTELhP26__spirv_AvcMcePayloadINTEL(i8 0, target("spirv.AvcMcePayloadINTEL") %[[McePayload]])
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcMcePayloadINTEL") @_Z47__spirv_SubgroupAvcMceSetInterShapePenaltyINTELmP26__spirv_AvcMcePayloadINTEL(i64 0, target("spirv.AvcMcePayloadINTEL") %[[McePayload]])
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcMcePayloadINTEL") @_Z51__spirv_SubgroupAvcMceSetInterDirectionPenaltyINTELhP26__spirv_AvcMcePayloadINTEL(i8 0, target("spirv.AvcMcePayloadINTEL") %[[McePayload]])
// CHECK-amd-llvm-spirv: call spir_func target("spirv.AvcMcePayloadINTEL") @_Z54__spirv_SubgroupAvcMceSetMotionVectorCostFunctionINTELmDv2_jhP26__spirv_AvcMcePayloadINTEL(i64 0, <2 x i32> zeroinitializer, i8 0, target("spirv.AvcMcePayloadINTEL") %[[McePayload]])
...
// CHECK-amd-llvm-spirv: call spir_func i8 @_Z69__spirv_SubgroupAvcMceGetInterReferenceInterlacedFieldPolaritiesINTELjjP25__spirv_AvcMceResultINTEL(i32 0, i32 0, target("spirv.AvcMceResultINTEL") %[[MceResult]])
