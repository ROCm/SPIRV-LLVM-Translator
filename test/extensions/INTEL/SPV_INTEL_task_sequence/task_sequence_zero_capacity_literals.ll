...
; RUN: amd-llvm-spirv %t.bc --spirv-ext=+SPV_INTEL_task_sequence -o %t.spv
...
; RUN: amd-llvm-spirv %t.bc --spirv-ext=+SPV_INTEL_task_sequence,+SPV_KHR_untyped_pointers -o %t.spv
; RUN: amd-llvm-spirv %t.spv -to-text -o %t.spt
